...
public class calendarView extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        int option = JOptionPane.showConfirmDialog(null,addTaskInternal,"Registrar", JOptionPane.OK_CANCEL_OPTION, JOptionPane.DEFAULT_OPTION, null);
        switch (option) {
            case JOptionPane.OK_OPTION:
                String[] tasks = (String[])jTable1.getValueAt(jTable1.getSelectedRow(), jTable1.getSelectedColumn());
                String[] cpyTasks = tasks;
                tasks = new String[cpyTasks.length+1];
                for (int i = 0; i < cpyTasks.length; i++) {
                    tasks[i] = cpyTasks[i];
                }
                jTable1.setValueAt(tasks, jTable1.getSelectedRow(), jTable1.getSelectedColumn());
                ...
                this.actualCalendar.addTask(this.actualYear + "-" + month + "-" + cpyTasks[0], t);
                updateTasks();
                break;
